            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex items-center justify-between h-20 sm:h-24">
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 sm:gap-5 group hover:opacity-95 transition-all"
                    >
                        ...
                        <img
                            src={LOGO_TEXT}
                            alt="RoamHub Tour"
                            className="hidden lg:block h-[175px] w-auto object-contain drop-shadow-sm"
                            onError={() => setLogoError(true)}
                        />
                    </button>
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        <button
                            ...
                            className="hidden sm:flex items-center gap-2 px-4 py-2.5 rounded-2xl border border-gray-100 hover:bg-gray-50 transition-all"
                        >
